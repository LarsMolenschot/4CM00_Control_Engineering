...
PRODUCT_NAME              = Hardware_Openloop_FRF_setup
MAKEFILE                  = Hardware_Openloop_FRF_setup.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Hardware_Openloop_FRF_setup.elf
...
%.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_Openloop_FRF_setup.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/Hardware_Openloop_FRF_setup.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_Openloop_FRF_setup_data.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/Hardware_Openloop_FRF_setup_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Hardware_Openloop_FRF_setup_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
