...
#ifndef Hardware_FRF_setup_h_
#define Hardware_FRF_setup_h_
#ifndef Hardware_FRF_setup_COMMON_INCLUDES_
#define Hardware_FRF_setup_COMMON_INCLUDES_
#include <string.h>
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_mode.h"
#endif                                 /* Hardware_FRF_setup_COMMON_INCLUDES_ */
...
} DW_Hardware_FRF_setup_T;

/* Parameters (default storage) */
struct P_Hardware_FRF_setup_T_ {
  ...
  real_T Quantizer2_Interval;          /* Expression: (2*pi)/(500*4)
                                        ...
                                        */
  real_T Gain_Gain_h;                  /* Expression: 0.007
...
struct tag_RTM_Hardware_FRF_setup_T {
...
extern P_Hardware_FRF_setup_T Hardware_FRF_setup_P;

/* Block signals (default storage) */
extern B_Hardware_FRF_setup_T Hardware_FRF_setup_B;

/* Block states (default storage) */
extern DW_Hardware_FRF_setup_T Hardware_FRF_setup_DW;

/* Model entry point functions */
extern void Hardware_FRF_setup_initialize(void);
extern void Hardware_FRF_setup_step(void);
extern void Hardware_FRF_setup_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Hardware_FRF_setup_T *const Hardware_FRF_setup_M;
 ...
 *
 * '<Root>' : 'Hardware_FRF_setup'
 * '<S1>'   : 'Hardware_FRF_setup/Controller (PD) - FRF'
 * '<S2>'   : 'Hardware_FRF_setup/Fourth Order Motion System'
 * '<S3>'   : 'Hardware_FRF_setup/Measurement Block'
 * '<S4>'   : 'Hardware_FRF_setup/Ref power'
 * '<S5>'   : 'Hardware_FRF_setup/Subsystem'
 * '<S6>'   : 'Hardware_FRF_setup/Fourth Order Motion System/Ethercat E-box'
 * '<S7>'   : 'Hardware_FRF_setup/Fourth Order Motion System/Ethercat Supervisor'
 * '<S8>'   : 'Hardware_FRF_setup/Measurement Block/SPERTE_measurement_function'
 */
#endif                                 /* Hardware_FRF_setup_h_ */
