...
#ifndef Hardware_Performance_run_h_
#define Hardware_Performance_run_h_
#ifndef Hardware_Performance_run_COMMON_INCLUDES_
#define Hardware_Performance_run_COMMON_INCLUDES_
#include <string.h>
#include <stdio.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_mode.h"
#endif                           /* Hardware_Performance_run_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  real_T SFunction_c[3];               /* '<S5>/S-Function' */
  real_T ec_Ebox_o1[2];                /* '<S6>/ec_Ebox' */
  real_T ec_Ebox_o2[2];                /* '<S6>/ec_Ebox' */
  real_T ec_Ebox_o3[8];                /* '<S6>/ec_Ebox' */
  real_T Gain[2];                      /* '<S6>/Gain' */
<<<<<<< Updated upstream
  real_T Gain1;                        /* '<S1>/Gain1' */
  real_T Dctnotch2;                    /* '<S1>/Dctnotch2' */
  real_T Dctleadlag3;                  /* '<S1>/Dctleadlag3' */
  real_T Dctleadlag4;                  /* '<S1>/Dctleadlag4' */
  real_T Dct1lowpass5;                 /* '<S1>/Dct1lowpass5' */
=======
...
typedef struct {
  ...
  real_T SFunction1_RWORK[2];          /* '<S7>/S-Function1' */
<<<<<<< Updated upstream
  real_T Dctnotch2_RWORK[4];           /* '<S1>/Dctnotch2' */
  real_T Dctleadlag3_RWORK[2];         /* '<S1>/Dctleadlag3' */
  real_T Dctleadlag4_RWORK[2];         /* '<S1>/Dctleadlag4' */
  real_T Dct1lowpass5_RWORK[2];        /* '<S1>/Dct1lowpass5' */
=======
...
>>>>>>> Stashed changes
  ...
  int_T SFunction1_IWORK;              /* '<S7>/S-Function1' */
  struct {
    int_T Count;
    int_T Decimation;
...
} DW_Hardware_Performance_run_T;

/* Parameters (default storage) */
struct P_Hardware_Performance_run_T_ {
...
>>>>>>> Stashed changes
  ...
  real_T Quantizer2_Interval;          /* Expression: (2*pi)/(500*4)
                                        ...
                                        */
  real_T Gain_Gain_h;                  /* Expression: 0.0052
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gain1_Gain;                   /* Expression: 0.000024
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T Quantizer3_Interval;          /* Expression: (2*pi)/(500*4)
                                        * Referenced by: '<Root>/Quantizer3'
                                        */
  real_T Gain2_Gain;                   /* Expression: 0.000271
...
struct tag_RTM_Hardware_Performance_run_T {
...
extern P_Hardware_Performance_run_T Hardware_Performance_run_P;

/* Block signals (default storage) */
extern B_Hardware_Performance_run_T Hardware_Performance_run_B;

/* Block states (default storage) */
extern DW_Hardware_Performance_run_T Hardware_Performance_run_DW;

/* Model entry point functions */
extern void Hardware_Performance_run_initialize(void);
extern void Hardware_Performance_run_step(void);
extern void Hardware_Performance_run_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Hardware_Performance_run_T *const Hardware_Performance_run_M;
...
<<<<<<< Updated upstream
 * '<S1>'   : 'Hardware_Performance_run/Controller_13p5Hz_N52p9_LL_LL_LPF'
 * '<S2>'   : 'Hardware_Performance_run/Fourth Order Motion System'
=======
 * '<S1>'   : 'Hardware_Performance_run/Fourth Order Motion System'
 * '<S2>'   : 'Hardware_Performance_run/Load_Controller_V2_lowpass_13_5Hz_noI'
>>>>>>> Stashed changes
 * '<S3>'   : 'Hardware_Performance_run/Measurement Block'
 * '<S4>'   : 'Hardware_Performance_run/Ref power'
 * '<S5>'   : 'Hardware_Performance_run/Subsystem'
 * '<S6>'   : 'Hardware_Performance_run/Fourth Order Motion System/Ethercat E-box'
 * '<S7>'   : 'Hardware_Performance_run/Fourth Order Motion System/Ethercat Supervisor'
 * '<S8>'   : 'Hardware_Performance_run/Measurement Block/SPERTE_measurement_function'
 */
#endif                                 /* Hardware_Performance_run_h_ */
