...
void Hardware_Performance_run_initialize(void)
{
  ...
  /* External mode info */
  Hardware_Performance_run_M->Sizes.checksums[0] = (2079250095U);
  Hardware_Performance_run_M->Sizes.checksums[1] = (4118662596U);
  Hardware_Performance_run_M->Sizes.checksums[2] = (268686097U);
  Hardware_Performance_run_M->Sizes.checksums[3] = (3501269418U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctleadlag2 (dleadlag) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_G_LL_N59p9_5/Dctleadlag2");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctnotch3 (dnotch) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_G_LL_N59p9_5/Dctnotch3");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
