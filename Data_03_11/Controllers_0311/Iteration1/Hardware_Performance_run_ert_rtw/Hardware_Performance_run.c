...
void Hardware_Performance_run_step(void)
{
  ...
  /* S-Function (dnotch): '<S1>/Dctnotch3' */

  /* Level2 S-Function Block: '<S1>/Dctnotch3' (dnotch) */
  {
  ...
  rtb_Sum2 = ((Hardware_Performance_run_P.Gain1_Gain_j * rtb_Sum2 +
    ...
    Hardware_Performance_run_B.Dctnotch3;
...
void Hardware_Performance_run_initialize(void)
{
  ...
  /* External mode info */
  Hardware_Performance_run_M->Sizes.checksums[0] = (3546360399U);
  Hardware_Performance_run_M->Sizes.checksums[1] = (4145182875U);
  Hardware_Performance_run_M->Sizes.checksums[2] = (1521512905U);
  Hardware_Performance_run_M->Sizes.checksums[3] = (2859360233U);
  ...
  Hardware_Performance_run_M->Sizes.numSFcns = (6);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctleadlag2 (dleadlag) */
    {
      SimStruct *rts = Hardware_Performance_run_M->childSfunctions[4];
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortWidthAsInt(rts, 0, 1);
          ssSetOutputPortSignal(rts, 0, ((real_T *)
            &Hardware_Performance_run_B.Dctleadlag2));
        }
      }
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_G_LL_N59p6_3/Dctleadlag2");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       Hardware_Performance_run_P.Dctleadlag2_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       Hardware_Performance_run_P.Dctleadlag2_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       Hardware_Performance_run_P.Dctleadlag2_P3_Size);
      }

      /* work vectors */
      ssSetRWork(rts, (real_T *) &Hardware_Performance_run_DW.Dctleadlag2_RWORK
                 [0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_DOUBLE);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &Hardware_Performance_run_DW.Dctleadlag2_RWORK[0]);
      }
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctnotch3 (dnotch) */
    {
      SimStruct *rts = Hardware_Performance_run_M->childSfunctions[5];
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &Hardware_Performance_run_B.Dctleadlag2;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidthAsInt(rts, 0, 1);
        }
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_G_LL_N59p6_3/Dctnotch3");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)
                       Hardware_Performance_run_P.Dctnotch3_P1_Size);
        ssSetSFcnParam(rts, 1, (mxArray*)
                       Hardware_Performance_run_P.Dctnotch3_P2_Size);
        ssSetSFcnParam(rts, 2, (mxArray*)
                       Hardware_Performance_run_P.Dctnotch3_P3_Size);
        ssSetSFcnParam(rts, 3, (mxArray*)
                       Hardware_Performance_run_P.Dctnotch3_P4_Size);
        ssSetSFcnParam(rts, 4, (mxArray*)
                       Hardware_Performance_run_P.Dctnotch3_P5_Size);
      }

      /* work vectors */
      ssSetRWork(rts, (real_T *) &Hardware_Performance_run_DW.Dctnotch3_RWORK[0]);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_DOUBLE);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &Hardware_Performance_run_DW.Dctnotch3_RWORK[0]);
      }
  ...
  /* Start for S-Function (dnotch): '<S1>/Dctnotch3' */
  /* Level2 S-Function Block: '<S1>/Dctnotch3' (dnotch) */
  {
    SimStruct *rts = Hardware_Performance_run_M->childSfunctions[5];
    sfcnStart(rts);
...
void Hardware_Performance_run_terminate(void)
{
  ...
  /* Terminate for S-Function (dnotch): '<S1>/Dctnotch3' */
  /* Level2 S-Function Block: '<S1>/Dctnotch3' (dnotch) */
  {
    SimStruct *rts = Hardware_Performance_run_M->childSfunctions[5];
    sfcnTerminate(rts);
