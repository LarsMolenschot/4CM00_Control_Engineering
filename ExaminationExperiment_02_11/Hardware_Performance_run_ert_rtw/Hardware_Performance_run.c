...
void Hardware_Performance_run_initialize(void)
{
  ...
  /* External mode info */
  Hardware_Performance_run_M->Sizes.checksums[0] = (2826469513U);
  Hardware_Performance_run_M->Sizes.checksums[1] = (2241600716U);
  Hardware_Performance_run_M->Sizes.checksums[2] = (2637390862U);
  Hardware_Performance_run_M->Sizes.checksums[3] = (2264869220U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctnotch2 (dnotch) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_13p5Hz_N52p5_53_LL_LL_LPF/Dctnotch2");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctleadlag3 (dleadlag) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_13p5Hz_N52p5_53_LL_LL_LPF/Dctleadlag3");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dctleadlag4 (dleadlag) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_13p5Hz_N52p5_53_LL_LL_LPF/Dctleadlag4");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: Hardware_Performance_run/<S1>/Dct1lowpass5 (dlowpass1) */
    {
      ...
      ssSetPath(rts,
                "Hardware_Performance_run/Controller_13p5Hz_N52p5_53_LL_LL_LPF/Dct1lowpass5");
      ssSetRTModel(rts,Hardware_Performance_run_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
