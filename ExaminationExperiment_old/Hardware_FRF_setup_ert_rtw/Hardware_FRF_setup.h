...
extern void Hardware_FRF_setup_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void Hardware_FRF_setup_initialize(void);
extern void Hardware_FRF_setup_step0(void);/* Sample time: [0.0s, 0.0s] */
extern void Hardware_FRF_setup_step2(void);/* Sample time: [0.002s, 0.0s] */
extern void Hardware_FRF_setup_step(int_T tid);
 ...
 * '<S1>'   : 'Hardware_FRF_setup/Fourth Order Motion System'
 * '<S2>'   : 'Hardware_FRF_setup/Load_FFW_5Hz'
 * '<S3>'   : 'Hardware_FRF_setup/Measurement Block'
 * '<S4>'   : 'Hardware_FRF_setup/Real-time scope'
 * '<S5>'   : 'Hardware_FRF_setup/Ref power'
 * '<S6>'   : 'Hardware_FRF_setup/Subsystem'
 * '<S7>'   : 'Hardware_FRF_setup/Fourth Order Motion System/Ethercat E-box'
 * '<S8>'   : 'Hardware_FRF_setup/Fourth Order Motion System/Ethercat Supervisor'
 * '<S9>'   : 'Hardware_FRF_setup/Measurement Block/SPERTE_measurement_function'
 */
