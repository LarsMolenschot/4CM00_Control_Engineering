###########################################################################
## Makefile generated for component 'Hardware_FFW'. 
## 
## Makefile     : Hardware_FFW.mk
## Generated on : Tue Oct 21 10:06:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Hardware_FFW.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Hardware_FFW.elf
...
DEFINES_STANDARD = -DMODEL=Hardware_FFW -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Hardware_FFW_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Hardware_FFW_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_FFW.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/Hardware_FFW.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_FFW_data.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/Hardware_FFW_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Hardware_FFW_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
